...
export const LogoDark: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      <defs>
        <pattern id="pattern0_1_1063" patternContentUnits="objectBoundingBox" width="1" height="1">
          <use xlinkHref="#image0_1_1063" transform="matrix(0.0169643 0 0 0.015904 0 -0.00892857)" />
        </pattern>
        <image
          id="image0_1_1063"
          width="448"
